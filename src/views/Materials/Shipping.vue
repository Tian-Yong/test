    ...
    <Form @submitForm="submitForm" @resetForm="resetForm" :parameter="text">
      <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="80px">
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="24">
            <el-form-item label="适用车型" prop="vehicle">
          ...
          <el-col :span="12">
            <el-form-item label="供应商" prop="discount">
          ...
          <el-col :span="12">
            <el-form-item label="收货数量" prop="price">
              <el-input v-model="ruleForm.price">
                <span slot="append">桶</span>
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="收货价格" prop="price">
              <el-input v-model="ruleForm.price">
          ...
          <el-col :span="12">
            <el-form-item label="收货金额" prop="price">
              <el-input v-model="ruleForm.price">
                <span slot="append">元</span>
              </el-input>
            </el-form-item>
          ...
          <el-col :span="12" style=" position:relative;">
            <el-form-item label="结算方式" prop="nature">
              <el-select
                v-model="ruleForm.nature"
                placeholder="请选择"
                style="width:100%;padding-right:73px;"
              >
                <el-option label="区域一" value="shanghai"></el-option>
                <el-option label="区域二" value="beijing"></el-option>
              </el-select>
            ...
            <el-popover placement="right" width="500" trigger="click">
              <button class="new" type="button" slot="reference">
                <el-link type="primary">新建</el-link>
              </button>
            </el-popover>
          </el-col>
          <el-col :span="24">
          ...
          <el-col :span="12">
            <el-form-item label="出货数量" prop="price">
              <el-input v-model="ruleForm.price">
                <span slot="append">元</span>
              </el-input>
            </el-form-item>
          ...
          <el-col :span="12">
            <el-form-item label="出货价格" prop="price">
              <el-input v-model="ruleForm.price">
                <span slot="append">元</span>
              </el-input>
            </el-form-item>
