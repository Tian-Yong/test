  ...
  <div>
    <Form @submitForm="submitForm" @resetForm="resetForm" :parameter="text">
      <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="80px">
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="材料编号" prop="coding">
          ...
          <el-col :span="12">
            <el-form-item label="性质类型" prop="nature">
          ...
          <el-col :span="12">
            <el-form-item label="库存上限" prop="upper">
          ...
          <el-col :span="24">
            <span>适配服务</span>
            <el-link type="primary" style="float:right" :underline="true">编辑</el-link>
            <el-divider></el-divider>
          </el-col>
          <el-col :span="24">
            <el-form-item>
