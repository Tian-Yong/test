    ...
    <el-row>
      <el-col :span="12">
        ...
        <ul class="list-unstyled">
          <li>或者你可以去:</li>
          <li class="link-type">
            <el-link type="primary"><router-link to="/">回首页</router-link></el-link>
          </li>
          <li class="link-type">
            <el-link type="primary"><a href="https://www.taobao.com/">随便看看</a></el-link>
          </li>
          <li>
            <el-link type="primary"><a @click.prevent="dialogVisible=true" href="#">点我看图</a></el-link>
            </li>
        </ul>
      </el-col>
      <el-col :span="12">
